...
const mockeduseGetProductDetailsAllList = useGetProductDetailsAllList as jest.Mock;
...
describe('AllProductDashboard', () => {
  ...
  beforeEach(() => {
    ...
    mockeduseGetProductDetailsAllList.mockImplementation(() => ({
      isLoading: true,
        ...
        <QueryClientProvider contextSharing={true} client={queryClient}>
          <PostContext.Provider value={contextValue}>
            <Context.Provider value={null}>
               <AllProductComponent is_search = {"test"} />
            </Context.Provider>
