...
import { GaiaScore } from "../GaiaScore";
...
describe("GaiaScore", () => {
  ...
  it("should render the component", async () => {
    ...
    await act(() => {
      const sortLabel = screen.getAllByTestId("ArrowDownwardIcon");
      fireEvent.click(sortLabel[0]);
      fireEvent.click(sortLabel[0]);
      const expandMore = screen.getAllByTestId("ExpandMoreIcon");
      fireEvent.click(expandMore[0])
    })
  }, 8000);
